...
def def_model(cfg, device):
    module_name = cfg.get("model", {}).get("module", "model")
    mod = importlib.import_module(module_name)
    ae_network = getattr(mod, "LS_DF_net")(cfg).to(device)
            ...
            if calculate_errors:
                        ...
                        if "GALLOP" in cfg["dataset"]["name"]:
                            ...
                            for ind, tt_s in enumerate(tt_sort[:10]):
                                ...
                                if saveplots:
                                    ...
                                    plt.savefig(f'embedding_plots/2d_{model_id}_{cfg["model"]["module"]}.png')
                            ...
                            if saveplots:
                                ...
                                plt.savefig(f'embedding_plots/2d_{model_id}_{cfg["model"]["module"]}.png', transparent=True, dpi=500)
                ...
                if "FAUST" not in cfg["dataset"]["name"]:
                    ...
                    if saveplots:
                        ...
                        plt.savefig(f'embedding_plots/3d_{model_id}_{cfg["model"]["module"]}.png')
